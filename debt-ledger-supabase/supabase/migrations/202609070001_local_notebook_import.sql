...
begin
  ...
  v_result := jsonb_build_object('business_id',v_business,'customer_count',jsonb_array_length(p_notebook->'customers'),'entry_count',jsonb_array_length(p_notebook->'entries'));

...
select is(public.local_notebook_import_version(),3,'Resumable verified import capability is version 3');
...
select is((public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')->>'verified')::boolean,true,'Server reconciliation passes');
select is((public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')->>'customer_count')::int,1,'Verification reports all customers');
select is((public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')->>'entry_count')::int,4,'Verification reports all entries');
select is((public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')->>'category_count')::int,1,'Verification reports all categories');
select is((public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')->>'balance_minor')::numeric,900000::numeric,'Verification reports exact minor-unit balance');
select is(public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')->>'currency','YER','Verification reports currency without aggregation');
...
select throws_ok($$select public.verify_local_notebook_import('93822222-2222-2222-2222-222222222222')$$,'P0002','Notebook import not found','Another account cannot verify or discover the import');
select * from finish();
rollback;

...
async function bootstrap() {
  ...
  const validLogLevels = Object.values(LogLevel) as string[];
  ...
  // Global Exception Filter for uniform error envelopes and logging
  ...
  const config = new DocumentBuilder()
    ...
    .addTag('otp', 'Enterprise WhatsApp OTP Verification Engine')
  ...
  if (fs.existsSync(dashboardDistPath)) {
    ...
    console.log(`📊 Dashboard served statically from: ${dashboardDistPath}`);
  }

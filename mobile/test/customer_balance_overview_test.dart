...
import 'package:muthbat/features/customer/presentation/screens/customer_balance_overview.dart';

void main() {
  testWidgets('personal overview separates credit and debt across currencies', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: CustomerBalanceOverview(
            summaries: [
              for (final row in [
                ('a', 'YER', 100.0),
                ('b', 'YER', -20.0),
